...
Così facendo si è ottenuta una elevata sicurezza, unita alla facilità di installazione di un nuovo dispositivo, in quanto è necessario solamente trasportargli la VLAN che utilizza e non quelle presenti nel tunnel. \\
Lo svantaggio di questa modalità è l'aver aggiunto un piccolo overhead ai pacchetti, che risulta trascurabile.
...
\begin{figure}[H]
	...
	\caption{Schermata di esempio di Directory Lister}
	\label{fig:Schermata di esempio di Directory Lister}
\end{figure}
