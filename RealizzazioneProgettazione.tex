...
Si è notato che la posizione GPS rilevata automaticamente del software era troppo imprecisa, ma la funzionalità è di elevata importanza vista l'estensione della rete. Si è dunque deciso di inserirle manualmente, sovrascrivendo il dato presente. \\
...
\end{figure}
Per quanto riguarda la rete Corporate il Autentication Server, non contenendo nessuna politica per l'approvazione delle richieste, si comporterà da Proxy ed invierà la richiesta al server NPS.\\
