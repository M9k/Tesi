...
L'intervallo di valori accettati per il numero di alert checks è stato scelto in modo tale da permettere una individuazione precisa della problematica senza aggiungere troppa verbosità.
