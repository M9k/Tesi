...
Il servizio Microsoft verificherà innanzitutto il certificato digitale, rifiutando immediatamente la richiesta nel caso non corrispondesse a quanto atteso. Se il certificato corrisponde, invece, procederà a effettuare un riscontro tra le credenziali e gli account presenti nell'Active Directory, individuando la presenza o meno dell'utente.\\\\
